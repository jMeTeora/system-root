package jmeteora.system.apidata;
...
public class Paths {
	public static final File repoDir = new File(new File("/", "opt"), "jmeteora-system");
	public static final String REPOURL = "https://github.com/jMeTeora/system-root";
