package jmeteora.system.apidata.languagepack;
...
public final class LanguagePackKeys {
	...
	public static final String GITREPOUPDATED = "GIT_REPO_UPDATED";
	public static final String UPDATINGUPDATERFILE = "UPDATING_UPDATER_FILE";
